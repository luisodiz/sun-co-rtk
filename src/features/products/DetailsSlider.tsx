...
const SliderNavigation = ({ slidesCount }: SliderNavigation) => {
...
const NavButton = styled.button<{ readonly $isPrev?: boolean }>`
  border: none;
  cursor: pointer;
  width: 40px;
  height: 40px;
...
interface DetailsSlider {
  slides: string[]
}

const DetailsSlider = ({ slides }: DetailsSlider) => {
  return (
    <StyledDetailsSlider
      spaceBetween={16}
      slidesPerView={1}
