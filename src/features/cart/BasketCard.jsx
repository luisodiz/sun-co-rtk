...
import {ImgWrapper, Title, Subtitle, Price} from '../products/Card'
import CountChanger from './CountChanger'

import {selectCartItemById, removeFromCart, updateProduct} from './cartSlice'

const BasketCard = ({productId}) => {
  const dispatch = useDispatch()
  const product = useSelector(state => selectCartItemById(state, productId))
      ...
      >
        ...
        >
          ...
          <StyledPrice>
            ...
            <p>For one: <span>{formatToUSD(product.priceWithDiscount)}</span>
            </p>
            {product.discount &&
              <p className="discount">Total discount: <span>{formatToUSD(
                product.discountInUsd)}</span></p>}
          </StyledPrice>
        </StyledFlex>
